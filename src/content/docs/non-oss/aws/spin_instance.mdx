...
<Admonition type="question" title="Bonnes pratiques">
...
<Admonition type="example" title="Nombre d'instances">
...
<Admonition type="warning" title="Clé d'authentification">
...
<Admonition type="note" title="Voici les noms d'utilisateur par défaut des AMI">
