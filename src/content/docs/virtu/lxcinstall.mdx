...
<Admonition type="tip" title="Conventions et bonnes pratiques">
...
<Admonition type="note" title="Exemple ici">
...
Debian est installé, mais tout nu. On pense à configurer ça proprement. Un guide est disponible sur la page [configuration d'une VM](/virtu/serverconfig).
