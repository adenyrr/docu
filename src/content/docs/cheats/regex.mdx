...
description: "Référence rapide des expressions régulières — syntaxe universelle, PCRE, et usages dans les outils Linux courants."
...
<Admonition type="tip" title="Le point `.` ne correspond pas aux newlines">
...
<Admonition type="info" title="Lookaround = zéro largeur">
...
<Admonition type="warning" title="Performance">
