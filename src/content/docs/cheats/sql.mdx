---
title: "SQL — Cheat Sheet : Manipulation de données"
description: "Référence rapide pour les opérations DML (Data Manipulation Language) et les requêtes courantes."
...
<Admonition type="tip" title="Ordre d'exécution">
...
<Admonition type="warning" title="Toujours utiliser `WHERE`">
...
<Admonition type="danger" title="Pas de `WHERE` = tout supprimer">
...
<Admonition type="info" title="Propriétés ACID">
