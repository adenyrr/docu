---
title: "Linux — Cheat Sheet : Opérations sur les fichiers"
description: "Référence rapide pour la création, copie, déplacement, visualisation et manipulation des fichiers et répertoires."
...
<Admonition type="danger" title="rm -rf irréversible">
