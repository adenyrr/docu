...
<Admonition type="question" title="Pourquoi GitLab ?">
...
Le système doit être à jour et [configuré](/virtu/vminstall)

<Admonition type="info" title="Machine virtuelle">
...
<Admonition type="question" title="Pourquoi en conteneur Docker ?">
