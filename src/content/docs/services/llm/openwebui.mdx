...
<Admonition type="quote" title="Elle se défini elle-même par :">
...
<Admonition type="question" title="Pourquoi Ollama et OpenWebUI ?">
...
<Admonition type="failure" title="Installer les drivers *docker* pour nvidia">
...
<Disclosure type="tip" title="IA décensurée">
...
<Admonition type="warning" title="Taille du LLM = VRAM !">
...
<Disclosure type="tip" title="Changer le prompt système">
